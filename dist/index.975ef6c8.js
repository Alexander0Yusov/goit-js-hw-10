...
const api = new (0, _fetchCountriesDefault.default)();
...
function onInput(e1) {
    e1.preventDefault;
    const inputValue = e1.target.value.trim(" ");
    // особый синтаксис типа if...
    inputValue === "" && (0, _markup.clearEl)(rfs.singleCountryEl);
    inputValue === "" && (0, _markup.clearEl)(rfs.multiCountryEl);
    inputValue !== "" && api.fetchCountries(inputValue).then((ar)=>{
        if (ar.length === 1) {
            rfs.singleCountryEl.innerHTML = (0, _markup.firstWay)(ar[0]);
            (0, _markup.clearEl)(rfs.multiCountryEl);
        } else if (ar.length > 1 && ar.length <= 10) {
            rfs.multiCountryEl.innerHTML = (0, _markup.secondWay)(ar);
            (0, _markup.clearEl)(rfs.singleCountryEl);
...
},{"./css/styles.css":"1CY4s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./js/markup":"3TIfq","notiflix":"5z0Oc","lodash.debounce":"3JP5n","./js/fetchCountries":"dKuy9"}],"1CY4s":[function() {},{}],"gkKU3":[function(require,module,exports) {
...
},{}],"3TIfq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "firstWay", ()=>firstWay);
parcelHelpers.export(exports, "secondWay", ()=>secondWay);
parcelHelpers.export(exports, "clearEl", ()=>clearEl);
function firstWay(country) {
...
function secondWay(countryAr) {
    const markup = countryAr.map(({ name , flags  })=>{
        return `<li>
      <img src=${flags.svg} alt='flag image' />
      <p class='name'>${name.official}</p>
    </li>`;
